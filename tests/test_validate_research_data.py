...
class Tests(unittest.TestCase):
 def setUp(self):
  ...
  tsv(self.r/"terms.tsv",["term","reference"],[{"term":"metrics","reference":"O;T (T)"}]);tsv(self.r/"untranslated_terms.tsv",["term","reference"],[{"term":"eBPF","reference":"O"}])
 ...
 def test_marker(self):tsv(self.r/"terms.tsv",["term","reference"],[{"term":"x","reference":"T"}]);self.err("(T)")
